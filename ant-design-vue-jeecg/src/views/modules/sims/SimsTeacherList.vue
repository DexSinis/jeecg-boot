<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <simsTeacher-modal ref="modalForm" @ok="modalFormOk"></simsTeacher-modal>
  </a-card>
</template>

<script>
  import SimsTeacherModal from './modules/SimsTeacherModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'

  export default {
    name: "SimsTeacherList",
    ...
    data () {
      return {
       ...
       //     },
		...
		url: {
          list: "/sims/simsTeacher/list",
          delete: "/sims/simsTeacher/delete",
          deleteBatch: "/sims/simsTeacher/deleteBatch",
          exportXlsUrl: "sims/simsTeacher/exportXls",
          importExcelUrl: "sims/simsTeacher/importExcel",
       },
    }
  },
  computed: {
